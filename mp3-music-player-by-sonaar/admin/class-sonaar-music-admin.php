    ...
    */
    ...
    public function save_cmb2_defaults_on_first_load() {
        ...
        foreach ($option_keys as $option_key) {
            ...
            error_log("Defaults for $option_key saved");
        }
    }
    /**
    ...
    */
    ...
    public function init_options() {
        ...
        $options_name = array();
            ...
            $general_options->add_field( array(
                'name'                  => esc_html__('Post Types', 'sonaar-tts'),
                'type'                  => 'title',
                'id'                    => 'srmp3_posttypes_title',
                'description'           => esc_html('Choose the post types for which you want to enable audio uploads.', 'sonaar-tts'),
            ) );
            $general_options->add_field( array(
            ...
            $widget_player_options->add_field( array(
                'name'          => esc_html__('Translations', 'sonaar-tts'),
                'type'          => 'title',
                ...
                array_push($options_name, $audiopreview_options);
                    ...
                    $audiopreview_options->add_field( array(
                        ...
                        'type'       	=> 'own_slider',
                            ...
                            'max'         => '30',
                            'step'        => '1',
                        'value_label' => esc_html__('Default 3 seconds', 'sonaar-tts'),
            ...
            <?php if ( get_admin_page_title() ) : ?>
                ...
                <div class="nav-tab-wrapper">
                    <?php foreach ( $tabs as $option_key => $tab_data ) : ?>
                        <?php if ( isset( $tab_data['title'] ) ) : ?> <!-- Check if the title key exists -->
            ...
            $submenu_structures = [
                ...
                'srmp3_settings_tools' => [
                    ...
                    'conditional1' => [
                        ...
                        'exist'     => true,
                        'items' => [
                            'cmb2-id-srtools-templates-importer'            => esc_html__( 'Import Player Elementor Templates', 'sonaar-music' ),
