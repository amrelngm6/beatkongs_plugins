...
define('SRMP3_VERSION', '5.3'); // important to avoid cache issues on update
define('SRMP3_PRO_MIN_VERSION', '5.3'); // Minimum pro version required
...
add_action('wp_ajax_import_srmp3_template', 'import_srmp3_template');
