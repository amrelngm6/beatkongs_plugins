...
Tags: WooCommerce Product Addons, WooCommerce product options, WooCommerce custom fields, WooCommerce product fields, WooCommerce custom price field, WooCommerce custom product fields, product fields,
...
🔹 <strong>Date field</strong> - Custom Date Picker and  HTML5 default date picker.
...
🔹 Conditional Fields - Show or Hide fields based on values of other fields.
...
🔗 [Front end Demo](https://wcpa-free.demo2.acowebs.com/product/hat/) (See how it looks in the front-end website)
🔗 [Back end Demo](https://wcpa-free.demo2.acowebs.com/wp-admin/admin.php?page=wcpa-admin-ui#/) (Feel free to play around and see how this works in back-end)
...
<p>Being an award-winning software company,<br/>We have a dedicated team of  developers who focus on supercharging your E-commerce stores. Our endeavours are backed by the support and trust of 50,000+ happy customers spread over 130 countries.</p>
...
🔹 [Find all PRO features](https://acowebs.com/woo-custom-product-addons/)
...
1. Product addon fields preview
2. Product addon fields preview gif
3. Forms listing - Backend
4. Forms Edit view - Drag & Drop - Backend
5. Available fields types
...
* Bug fixes
= 3.0.7 =
* Woocommerce 8.6 Support
* Bug fixes
= 3.0.6 =
* Woocommerce 8.5 Support
* Bug fixes

= 3.0.5 =
* Breaking Changes Ahead - for those updating from version below 3.0.0 [Read more](https://acowebs.com/r/version-free-3-update)
* Woocommerce 8.3 Support
* Bug fixes

= 3.0.4 =
* Breaking Changes Ahead - for those updating from version below 3.0.0 [Read more](https://acowebs.com/r/version-free-3-update)
* Woocommerce 8.2 Support
* Bug fixes
= 3.0.3 =
* Breaking Changes Ahead - for those updating from version below 3.0.0 [Read more](https://acowebs.com/r/version-free-3-update)
...
= 3.0.2 =
* Breaking Changes Ahead - for those updating from version below 3.0.0 [Read more](https://acowebs.com/r/version-free-3-update)
* Option to change line item meta value format for select/radio/checkbox fields
* Bug fixes

= 3.0.0 =
* Breaking Changes Ahead - Plugin restructured entirely, All your custom css and custom js codes wont be working after this update - [Read more](https://acowebs.com/r/version-free-3-update)
* Updated UI for form creation
* ReactJS based form rendering
* New Features added
...
* Bug Fix: Translation warning
= 2.7.2 =
* Woocommerce 7.3.x Support
= 2.7.1 =
* New Plugin Images
* Woocommerce 7.1.x Support
= 2.7.0 =
* Wordpress 6.1.x Support
* Woocommerce 7.0.x Support
= 2.6.9 =
* Minor Bug Fix
* Woocommerce 6.9.x Support
= 2.6.8 =
* Minor Bug Fix
= 2.6.7 =
* WooCommerce 6.8.x Support
= 2.6.6 =
* WooCommerce 6.7.x Support
= 2.6.5 =
* WooCommerce 6.6.x Support
= 2.6.4 =
* Wordpress 6.0.x Support
* WooCommerce 6.5.x Support
= 2.6.3 =
* Bug Fix: New filter error in order meta data
= 2.6.2 =
* Woocommerce 6.4.x Support
= 2.6.1 =
* Woocommerce 6.3.x Support
= 2.6.0 =
* Bug Fix- Major Bug fix for initilal data not loading issue
* Woocommerce 6.2.x Support
= 2.5.9 =
* Wordpress 5.9.x Support
= 2.5.8 =
* Woocommerce 6.1.x Support
= 2.5.7 =
* Woocommerce 6.0.x Support
= 2.5.6 =
* Woocommerce 5.8.x Support
* Bug Fix - 'undefined' constant
= 2.5.5 =
...
== Upgrade Notice ==
= 3.0.0 =
* Breaking Changes Ahead - Plugin restructured entirely, All your custom css and custom js codes wont be working after this update https://acowebs.com/r/version-free-3-update
= 2.1.1 =
