...
function enqueue_dokan_beats_page_scripts() {
    ...
    //  wp_enqueue_style('beats-tailwind-page-css', plugin_dir_url(__FILE__) . 'assets/css/tailwind.css', array('wp-element'), '1.0', true);
     wp_enqueue_style('dokan-beats-page-css', 'https://beatkongs.medianssolutions.com/wp-content/plugins/dokan-lite/assets/css/dokan-product-category-ui.css?ver=1716242573');
