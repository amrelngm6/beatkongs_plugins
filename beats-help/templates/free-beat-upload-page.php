            ...
            <form class="dokan-beat-edit-form <?php echo $postMeta['beat_type'][0] ?? '';?>" role="form" method="post" id="post">
                ...
                <div class="dokan-form-top-area">
                    ...
                    <div class="content-half-part dokan-product-meta">
                        ...
                        <div class="flex  open-modal cursor-pointer" id="open-category-modal" data-modal="#dokan-product-category-modal" data-text="#fbu-category-text" data-input="#fbu-category">
