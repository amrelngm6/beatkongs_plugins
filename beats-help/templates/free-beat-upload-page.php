                ...
                <div class="dokan-form-top-area">
                    ...
                    <div class="content-half-part dokan-product-meta">
                        ...
                        <div class="flex">
                            ...
                            <div  class="w-full  open-modal" id="open-station-popup" data-modal="#fbu-category-modal" data-text="#fbu-category-text" data-input="#fbu-category">
                        ...
                        <div class="flex">
                            ...
                            <div  class="w-full open-modal" data-dokansclevel="0"  id="open-station-popup" data-modal="#fbu-station-modal" data-text="#fbu-station-text" data-input="#fbu-station">
                                <span class="dokan-select-product-category-icon"><i class="fas fa-edit"></i></span>
                            </div>
