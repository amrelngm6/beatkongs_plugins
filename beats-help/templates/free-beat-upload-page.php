                    ...
                    <div class="content-half-part dokan-product-meta">
                        ...
                        <div class="dokan-form-group">
                            ...
                            <div class="w-full flex gap-2">
                                ...
                                <input  type="hidden"  name="beat_slug" id="beat_slug" value="<?php echo $post['post_name'] ?? ''; ?>" class="dokan-form-control valid" placeholder="Link path.." aria-invalid="false">
                                <input disabled="true" style="max-width:200px" type="text"  id="beat_slug_value" value="<?php echo $post['post_name'] ?? ''; ?>" class="dokan-form-control valid" placeholder="Link path.." aria-invalid="false">
                                <span id="activate-permalink" class="cursor-pointer">Change</span> <span  class="cursor-pointer" style="display:none" id="validate-permalink">Validate</span> 
                                <span style="display:none" id="ajax-span-loader"><img src="<?php echo plugin_dir_url(__FILE__); ?>../assets/img/loader.gif" width="26" /></span>
                        ...
                        <div class="dokan-form-group">
                            ...
                            <input type="number" min="0" max="300" name="beat_bpm" id="beat_bpm" value="<?php echo $postMeta['beat_bpm'][0] ?? ''; ?>" class="dokan-form-control valid" placeholder="BPM (Beats per minute).." aria-invalid="false">
                        </div>


                        <div class="flex  open-modal cursor-pointer" id="open-category-modal" data-modal="#dokan-product-category-modal" data-modal-span="#dokan-selected-category-span" data-text="#fbu-category-text" data-input="#fbu-category">
                            <div  class="w-full dokan-form-group dokan-select-product-category dokan-category-open-modal" data-dokansclevel="0"  id="fbu-category-g">
                                ...
                                <div id="dokan_product_cat_res" class="dokan-select-product-category-title dokan-ssct-level-0"><span class="dokan-selected-category-product dokan-cat-selected text-sm font-semibold" id="fbu-category-text"><span><?php echo $selectedCategory ? implode(' , ', array_column($selectedCategory, 'name')) : 'Select Genre'; ?></span></span></div>
                            </div>
                            <div  class="w-full " >
                        ...
                        <div class="flex  open-modal cursor-pointer" data-dokansclevel="0"  id="open-station-modal" data-modal="#fbu-station-modal" data-text="#fbu-station-text" data-input="#fbu-station">
                            <div  class="w-full dokan-form-group dokan-select-product-category dokan-category-open-modal" data-dokansclevel="0"  id="fbu-stations-g">
                                ...
                                <div id="dokan_product_station_res" class="dokan-select-product-category-title dokan-ssct-level-0"><span class="dokan-selected-category-product dokan-cat-selected text-sm font-semibold" id="fbu-station-text"><span><?php echo $selectedStation ? implode(' , ', array_column($selectedStation, 'name')) : 'Select station'; ?></span></span></div>
                            </div>
                            <div  class="w-full">
                                <span class="dokan-select-product-category-icon"><i class="fas fa-edit"></i></span>
                            </div>
                        ...
                        <div class="dokan-form-group" id="beat_downloadable_section" style="display: <?php echo (isset($postMeta['beat_type'][0]) && $postMeta['beat_type'][0] == 'sell') ? 'block' : 'none'; ?>">
