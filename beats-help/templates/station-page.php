                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide" data-post-id="<?php echo $beat->ID;?>"
                                                    ...
                                                    <div class="srp_swiper-titles">
                                                        ...
                                                        <div class="srp_swiper-track-title">
                                                            <?php echo $beat->post_title;?></div>
                                        ...
                                        <div class="srp_tracklist">
                                            ...
                                            <ul class="srp_list"
                                                ...
                                                <li class="sr-playlist-item"
                                                    ...
                                                    data-artist="" data-trackID="<?php echo $beat->ID; ?>"
                                                    data-trackTime="0:22" data-relatedTrack="" data-post-url=""
                                                        ...
                                                        <div class="sr_track_cover">
                                                            ...
                                                            <div class="song-store-list-menu"><i
                                                                ...
                                                                <div class="song-store-list-container"><a
                                                                        ...
                                                                        target="_self" title="Share" aria-label="Share"
                                                                        data-source-post-id="<?php echo $beat->ID;?>"
                                                                        data-store-id="0-2" tabindex="1"><i
                                                                            class="sricon-share"></i></a><a href="#"
                                                                        class="song-store srp-fav-bt" target="_self"
                                                                        title="Like" aria-label="Like"
                                                                        data-source-post-id="<?php echo $beat->ID;?>"
                                                                        data-store-id="0-3" tabindex="1"><i
                                                                            class="sricon-heart-fill"></i></a>
                                                                </div>
                                                            </div>
                                                        </span>
