                ...
                <div class="inside">
                    ...
                    <div class="cmb2-wrap form-table">
                        <div id="cmb2-metabox-cmb2_usage_terms_box" class="cmb2-metabox cmb-field-list">
                            ...
                            <div class="cmb-row cmb-repeat-group-wrap cmb-type-group cmb2-id-usageterms-custom-options-group cmb-repeat"
                                data-fieldtype="group">
                                <div class="cmb-td">
                                    <div data-groupid="usageterms_custom_options_group"
                                        id="usageterms_custom_options_group_repeat"
                                        class="cmb-nested cmb-field-list cmb-repeatable-group sortable repeatable"
                                        style="width:100%;">
                                        <div class="cmb-row">
                                            <div class="cmb-th">
                                                <h2 class="cmb-group-name">Add your own custom license options</h2>
                                            </div>
                                        </div>
                                        <div id="cmb-group-usageterms_custom_options_group-0"
                                            class="postbox cmb-row cmb-repeatable-grouping" data-iterator="0"><button
                                                type="button" data-selector="usageterms_custom_options_group_repeat"
                                                data-confirm=""
                                                class="dashicons-before dashicons-no-alt cmb-remove-group-row"
                                            ...
                                            <div class="inside cmb-td cmb-nested cmb-field-list">
                                                <div class="cmb-row cmb-type-text-medium cmb2-id-usageterms-custom-options-group-0-usageterms-custom-options-item-name cmb-repeat-group-field"
                                                    data-fieldtype="text_medium">
                                                    <div class="cmb-th">
                                                        <label
                                                            for="usageterms_custom_options_group_0_usageterms_custom_options_item_name">Option
                                                            Name</label>
                                                    </div>
                                                    <div class="cmb-td">
                                                        <input type="text" class="cmb2-text-medium"
                                                            name="usageterms_custom_options_group[0][usageterms_custom_options_item_name]"
                                                            id="usageterms_custom_options_group_0_usageterms_custom_options_item_name"
                                                            value="" data-hash='b8epicea5ha0' />
                                                        <span class="cmb2-metabox-description">eg: 10 videos
                                                            included</span>

                                                    </div>
                                                </div>
                                                <div class="cmb-row cmb-type-text-medium cmb2-id-usageterms-custom-options-group-0-usageterms-custom-options-item-var cmb-repeat-group-field"
                                                    data-fieldtype="text_medium">
                                                    <div class="cmb-th">
                                                        <label
                                                            for="usageterms_custom_options_group_0_usageterms_custom_options_item_var">ID
                                                            Variable for the contract</label>
                                                    </div>
                                                    <div class="cmb-td">
                                                        <input type="text" class="cmb2-text-medium"
                                                            name="usageterms_custom_options_group[0][usageterms_custom_options_item_var]"
                                                            id="usageterms_custom_options_group_0_usageterms_custom_options_item_var"
                                                            value="" data-hash='1vlroq0pis2o'
                                                            placeholder="{your-unique-id}" />
                                                        <span class="cmb2-metabox-description">ID without space and
                                                            between curly
                                                            brackets. </span>

                                                    </div>
                                                </div>
                                                <div class="cmb-row cmb-type-faiconselect cmb2-id-usageterms-custom-options-group-0-usageterms-custom-options-item-icon cmb-repeat-group-field"
                                                    data-fieldtype="faiconselect">
                                                    <div class="cmb-th">
                                                        <label
                                                            for="usageterms_custom_options_group_0_usageterms_custom_options_item_icon">Icon</label>
                                                    </div>
                                                    <div class="cmb-td">
                                                ...
                                                <div class="cmb-row cmb-remove-field-row">
                                                    <div class="cmb-remove-row">
                                                        <button type="button"
                                                            data-selector="usageterms_custom_options_group_repeat"
                                                            data-confirm=""
                                                            class="cmb-remove-group-row cmb-remove-group-row-button alignright button-secondary">Remove
                                                            Option</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="cmb-row">
                                            <div class="cmb-td">
                                                <p class="cmb-add-row"><button type="button"
                                                        data-selector="usageterms_custom_options_group_repeat"
                                                        data-grouptitle=""
                                                        class="cmb-add-group-row button-secondary">Add License
                                                        Option</button></p>
                                            </div>
                                        </div>
                                    </div>
