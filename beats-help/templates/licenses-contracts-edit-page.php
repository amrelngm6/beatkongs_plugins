    ...
    <div class="dokan-dashboard-content dokan-product-listing">
        ...
        <article class="dokan-product-listing-area">
            ...
            <div class="dokan-message">
                ...
                <strong><?php esc_html_e( 'Success!', 'dokan-lite' ); ?></strong> <?php esc_html_e( 'The License has been updated successfully.', 'dokan-lite' ); ?>
            </div>
            <?php endif; ?>
            ...
            <div id="cmb2_usage_terms_box" class="postbox  license-box ">
                ...
                <div class="inside">
                    <form class="dokan-beat-license-edit-form" role="form" method="post" id="post">
                        ...
                        <input type="hidden" name="author_license_id" value="<?php echo $authorPost->ID ?? 0; ?>" />
