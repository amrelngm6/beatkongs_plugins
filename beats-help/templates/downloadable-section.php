...
">
                    ...
                    <tbody id="downloads-tbody">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    <input type="url" id="file-url-<?php echo $key; ?>" class="dokan-form-control dokan-w8 input_text wc_file_url" placeholder="https://" name="<?php echo $value->post_name; ?>_wc_file_url" value="" style="margin-right: 8px;">
                                    <input class="file_id" id="file-id-<?php echo $key; ?>" type="hidden" name="<?php echo $value->post_name; ?>_wc_file_id">
                                    <a href="#" class="downloads_media_manager dokan-btn dokan-btn-sm dokan-btn-default upload_file_button" data-input=".file_id" data-url=".wc_file_url">Choose&nbsp;file</a>
                                </p>
                            </td>
