=== SiteSEO - One Click SEO for WordPress ===
Contributors: pagelayer, softaculous
Tags: SEO, schema, xml sitemap, meta description, woocommerce seo, redirection, local seo, meta title, open graph, content analysis, instant indexing, breadcrumbs, analytics, rich snippets, broken link, video sitemap, robots.txt, seo audit, seo plugin
...
SiteSEO is an easy, fast and powerful SEO plugin for WordPress. Unlock your Website's potential and Maximize your online visibility with our SiteSEO Plugin!
...
1. Google Analytics: It is a tool which is used to track website traffic and if you choose to use Google Analytics as your Analytics integration then SiteSEO automatically injects the required Google Analytics Scripts to the pages you choose to add it to. To know about what data Google Analytics will track about your users check [Terms and Conditions](https://marketingplatform.google.com/about/analytics/terms/us/) | [Google Analytics](https://marketingplatform.google.com/about/analytics/)
2. Matomo Cloud: It is a analytics tool which is used to track website traffic and if you are using Matomo cloud as your option for Analytics then Matomo Cloud scripts will be injected to your pages. To know about what data Matomo Cloud will track about your users check [Matomo Cloud Privacy Policy](https://matomo.org/matomo-cloud-privacy-policy/) | [Matomo Cloud](https://matomo.org/matomo-cloud/)
3. Clarity: It is a user behaviour analytics tool, if you choose to use it then the required scripts will be injected to your pages. For information about the Data Processing and Data Protection of Microsoft Clarity https://www.clarity.ms read [Terms of Use](https://clarity.microsoft.com/terms) | [Microsoft Clarity](https://clarity.microsoft.com/)
4. IndexNow: It is used to inform Microsoft Bing about the latest content changes on users website.[Terms and Condition](https://www.indexnow.org/terms) | [IndexNow.org](https://www.indexnow.org)
5. Google PageSpeed API: Google PageSpeed is a service which helps in determining the Speed Score of the website and points out issues with SEO and Performance of the website [Terms and Conditions](https://console.cloud.google.com/tos?id=universal) | [PageSpeed Insight API](https://console.cloud.google.com/apis/library/pagespeedonline.googleapis.com)
6. Google Ping API: It's is used to notify Google about a page on your website [Terms and Conditions](https://policies.google.com/terms) | [Google Ping](https://google.com/ping)
7. Google Instant Index: https://indexing.googleapis.com is a API provided by Google Search Central which helps in getting the website or webpage getting indexed. [Terms and Conditions](https://developers.google.com/terms/site-terms) | [Google Search Central](https://developers.google.com)
8. Google Tag Manager: It is a tag management solution by Google https://www.googletagmanager.com/ [Terms and Conditions](https://www.google.com/intl/en/policies/terms/) | [Google Tag Manager](https://marketingplatform.google.com/about/tag-manager/)
9. Google Search Console API: Provides tools for running validation tests against single URLs [Terms and Conditions](https://console.cloud.google.com/tos?id=universal) | [Search Console API](https://console.cloud.google.com/apis/library/searchconsole.googleapis.com)
10. Google Optimize: It is used to do A/B testing https://www.googleoptimize.com [Terms and Condition](https://www.google.com/intl/en/policies/terms/) | [Google Optimize](https://marketingplatform.google.com/about/optimize/)
11. Google Analytics Reporting API: It is the most advanced programmatic method to access report data in Google Analytics. [Terms and Conditions](https://console.cloud.google.com/tos?id=universal) | [Google Analytics Reporting API](https://console.cloud.google.com/apis/library/analyticsreporting.googleapis.com)
12. Web Search Indexing API: Notifies Google Web Search when your web pages change. [Terms and Conditions](https://console.cloud.google.com/tos?id=universal) | [Web Search Indexing API](https://console.cloud.google.com/apis/library/indexing.googleapis.com)

== Credits ==
SiteSEO, a fork of SEOPress, extends its credits to the original developers [SEOPress](https://wordpress.org/plugins/wp-seopress/)
...
= 1.0.7 (April 17, 2024) =
* [Feature] Realtime Conntent Analysis for Gutenberg.
