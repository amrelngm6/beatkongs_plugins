...
function siteseo_sanitize_options_fields($input){
	...
	$siteseo_sanitize_fields = [
		...
		'breadcrumbs_i18n_home',
		'breadcrumbs_i18n_here',
		'breadcrumbs_i18n_author',
		'breadcrumbs_i18n_404',
		'breadcrumbs_i18n_search',
		'breadcrumbs_i18n_no_results',
		'breadcrumbs_i18n_attachments',
		'breadcrumbs_i18n_paged',
	];
